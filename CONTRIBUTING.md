...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/NeuromuscularDisease/neuromuscular-disease-ontology/issues/).
...
1. Open src/ontology/nmdo-edit.owl in your favourite editor, i.e. [Protege](https://protege.stanford.edu/). **Careful:** double check you are editing the correct file. There are many ontology files in this repository, but only one _editors file_!
