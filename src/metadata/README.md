 ...
 * [nmdo.yml](nmdo.yml)
     * Determines how your purl.obolibrary.org/obo/nmdo/ redirects will be handled
     ...
     * Paste in the contents of [nmdo.yml](nmdo.yml)
 ...
 * [nmdo.md](nmdo.md)
     ...
     * Paste in the contents of [nmdo.md](nmdo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
